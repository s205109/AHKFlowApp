...
(`docs/development/workflow.md:563`, "Merge with a merge commit, not a rebase merge.") describes
...
- [ ] The Cleanup warning
      (`docs/development/workflow.md:563`, "Merge with a merge commit, not a rebase merge.")
...
- The Cleanup warning points at this item
  (`docs/development/workflow.md:570`, "backlog 098 makes the removal script use the same rule.")
