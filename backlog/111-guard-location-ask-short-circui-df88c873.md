...
(`scripts/agents/agent-worktree-guard.common.ps1:3787`, "    if ($location.Action -ne 'Allow') { return $location }").
...
decisions (`scripts/agents/agent-worktree-guard.common.ps1:3735`, "function Get-AgentGuardActionSeverity {").
