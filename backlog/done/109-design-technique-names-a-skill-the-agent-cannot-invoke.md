...
- (`docs/development/workflow.md:349`, "mp-grill-with-docs") sets the Stage 2
  Technique. (`docs/development/workflow.md:900`, "is the Design technique")
...
- [x] Stage 2 Design names a technique an agent can call. Every place that
      states the technique agrees: (`docs/development/workflow.md:349`, "mp-grill-with-docs"),
      (`docs/development/workflow.md:900`, "is the Design technique"),
