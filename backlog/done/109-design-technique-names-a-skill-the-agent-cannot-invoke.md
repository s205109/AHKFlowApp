...
- (`docs/development/workflow.md:359`, "mp-grill-with-docs") sets the Stage 2
  Technique. (`docs/development/workflow.md:920`, "is the Design technique")
...
- [x] Stage 2 Design names a technique an agent can call. Every place that
      states the technique agrees: (`docs/development/workflow.md:359`, "mp-grill-with-docs"),
      (`docs/development/workflow.md:920`, "is the Design technique"),
