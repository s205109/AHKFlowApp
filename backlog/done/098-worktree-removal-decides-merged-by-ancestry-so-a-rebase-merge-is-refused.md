...
(`scripts/worktree-git.common.ps1:1082`, "function Test-BranchOwnWorkWasMerged {"), after a
...
merge commit on main (`scripts/worktree-git.common.ps1:671`, "    $parentLines = & git -C $RepoRoot rev-list --min-parents=2 --format='%P' $MainRef 2>$null"),
