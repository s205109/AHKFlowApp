...
(`scripts/pre-push-quick-checks.ps1:62`, "    Write-Step 'Checking citations in the private plans repository'")
and
(`scripts/pre-push-quick-checks.ps1:141`, "    Write-Step 'Checking the plans against the source'").
