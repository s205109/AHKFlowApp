...
(`scripts/pre-push-quick-checks.ps1:60`, "    Write-Step 'Checking citations in the private plans repository'")
and
(`scripts/pre-push-quick-checks.ps1:139`, "    Write-Step 'Checking the plans against the source'").
