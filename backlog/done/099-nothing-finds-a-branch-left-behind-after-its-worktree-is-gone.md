...
and logs (`scripts/remove-worktree-local-dev.ps1:1425`, "        Write-DiagnosticLog 'Watcher done (worktree removed; branch preserved).'") when
...
(`docs/development/workflow.md:673`, "Branch still present, worktree already gone."): a local
...
- [x] The Cleanup leftover check
      (`docs/development/workflow.md:673`, "Branch still present, worktree already gone.")
