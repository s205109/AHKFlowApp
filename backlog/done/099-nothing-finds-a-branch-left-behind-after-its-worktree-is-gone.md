...
(`docs/development/workflow.md:642`, "Branch still present, worktree already gone."): a local
...
- [x] The Cleanup leftover check
      (`docs/development/workflow.md:642`, "Branch still present, worktree already gone.")
