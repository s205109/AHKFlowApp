...
(`docs/development/workflow.md:599`, "Branch still present, worktree already gone."): a local
...
- [ ] The Cleanup leftover check
      (`docs/development/workflow.md:599`, "Branch still present, worktree already gone.")
...
- Found while implementing backlog 094, which re-pointed the claim
  (`docs/development/workflow.md:607`, "Until backlog 099 scripts this")
