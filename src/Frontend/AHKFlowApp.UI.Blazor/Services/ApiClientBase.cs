...
public abstract class ApiClientBase(HttpClient httpClient)
{
    ...
    protected static async Task<ApiProblemDetails?> TryReadProblem(HttpResponseMessage resp, CancellationToken ct)
    {
    ...
    protected static ApiResultStatus MapStatus(HttpStatusCode code) => code switch
    {
