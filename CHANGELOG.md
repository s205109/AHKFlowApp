...
- Clipboard delivery for Text hotstrings, with Auto, Hotstring, and Clipboard choices in the web UI and `--delivery auto|type|clipboard` plus UTF-8 `--replacement-file` support in the CLI.
