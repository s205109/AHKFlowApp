...
Stage 7 | docs done in Task 4: the scripts/README.md row, the AGENTS.md Git Workflow rule, the workflow.md Stage 9 paragraph; nothing else enumerates the suites
Stage 8 | review returned 6 findings; failure edge back to 4-execute. Recovery tasks:
  R1 CONFIRMED | a progress line here carried a bare citation to the AGENTS.md rule; tier 3 fails it, branch was CI-red. Verified: check-citation-freshness.ps1 exits 1. Fixed by naming the rule instead of its line.
