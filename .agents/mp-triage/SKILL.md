...
These are canonical role names — the actual label strings used in the issue tracker may differ. In this repo the mapping lives in `docs/agents/triage-labels.md`. Read it before you apply any label.
