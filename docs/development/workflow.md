...
the base (`scripts/worktree-git.common.ps1:1082`, "function Test-BranchOwnWorkWasMerged {"). A merge
...
(`scripts/worktree-git.common.ps1:958`, "function Get-WorkAfterMergeProof {"). Push that work, or
