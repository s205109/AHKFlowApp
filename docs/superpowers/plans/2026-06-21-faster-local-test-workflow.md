...
- Share non-E2E SQL startup in local runners:
  - Start one script-owned disposable SQL Server container for `test-fast.ps1 -Mode Integration`, `run-coverage.ps1`, and SQL-backed `measure-tests.ps1` selections.
