...
.DESCRIPTION
  ...
  coverage-tooling key names eleven scripts the local coverage run executes. Changing one of
  ...
  scripts. So this module can be stricter than CI on eleven paths, and never looser anywhere.
