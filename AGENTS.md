...
- Run the canonical five-step gate before you mark a pull request **ready**, not when you open the draft: [`docs/development/testing-workflow.md`](docs/development/testing-workflow.md#canonical-pre-pr-gate). That file still calls it the "pre-PR gate"; renaming its heading is wave-2 work — see [workflow.md#stage-6-verify](docs/development/workflow.md#stage-6-verify).
