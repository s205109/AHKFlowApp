...
Don't ask the user to test manually what you can verify yourself — use browser automation first (Playwright preferred; Claude in Chrome as fallback). Only ask for manual testing when automation genuinely can't cover it (e.g. real Azure AD login, visual judgment calls).
